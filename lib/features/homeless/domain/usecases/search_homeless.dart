...
class SearchHomeless implements UseCase<(List<HomelessEntity>, DocumentSnapshot?), SearchHomelessParams> {
  final HomelessRepository _repository;

  SearchHomeless(this._repository);

  @override
  Future<(List<HomelessEntity>, DocumentSnapshot?)> call(SearchHomelessParams params) async {
    return await _repository.searchHomeless(searchQuery: params.searchQuery, lastDocument: params.lastDocument);
  }
}
