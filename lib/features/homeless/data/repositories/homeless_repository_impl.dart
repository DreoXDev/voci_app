...
class HomelessRepositoryImpl implements HomelessRepository {
  ...
  Future<(List<HomelessEntity>, DocumentSnapshot?)> searchHomeless(
    ...
    final (homelessList, newLastDocument) = await _homelessFirestoreDatasource
        .searchHomeless(searchQuery: searchQuery, lastDocument: lastDocument);
    return (
  ...
  @override
  Future<HomelessEntity> getHomelessById({required String homelessId}) async {
